...
use App\Controller\Library\LibraryAddController;
use App\Controller\Library\LibraryDeleteController;
use App\Controller\Library\LibraryUpdateController;
use App\Entity\Book;
...
class LibraryAddControllerTest extends WebTestCase
{
    ...
    public function testLibraryAddController(): void
    {
        ...
        $this->assertInstanceOf("\App\Controller\Library\LibraryAddController", $cls);

        $cls = new LibraryDeleteController();
        $this->assertInstanceOf("\App\Controller\Library\LibraryDeleteController", $cls);

        $cls = new LibraryUpdateController();
        $this->assertInstanceOf("\App\Controller\Library\LibraryUpdateController", $cls);
    }
