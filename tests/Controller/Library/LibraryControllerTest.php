...
use App\Entity\Book;
use App\Controller\Library\LibraryController;
use App\Controller\Library\LibraryAPIController;
use App\Controller\Library\LibraryViewController;
...
class LibraryControllerTest extends WebTestCase
{
    ...
    {
        $this->assertInstanceOf("\App\Controller\Library\LibraryController", new LibraryController());
        $this->assertInstanceOf("\App\Controller\Library\LibraryAPIController", new LibraryAPIController());
        $this->assertInstanceOf("\App\Controller\Library\LibraryViewController", new LibraryViewController());
    }
