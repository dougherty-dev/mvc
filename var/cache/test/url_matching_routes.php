...
return [
    ...
    [ // $dynamicRoutes
        ...
        92 => [[['_route' => 'api_library_book_isbn', '_controller' => 'App\\Controller\\LibraryAPIController::apiLibraryBookIsbn'], ['isbn'], null, null, false, true, null]],
        124 => [[['_route' => 'card_deck_draw_number', '_controller' => 'App\\Controller\\CardDrawController::cardDeckDrawNumber'], ['number'], null, null, false, true, null]],
        157 => [[['_route' => 'card_deck_draw_deal_players', 'players' => 0, 'cards' => 0, '_controller' => 'App\\Controller\\CardDrawController::cardDeckDealPlayersCards'], ['players', 'cards'], null, null, false, true, null]],
        191 => [[['_route' => 'library_edit_id', '_controller' => 'App\\Controller\\LibraryController::libraryEditID'], ['id'], null, null, false, true, null]],
        212 => [
