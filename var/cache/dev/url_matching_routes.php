...
return [
    ...
    [ // $staticRoutes
        ...
        '/proj/poker/begin' => [[['_route' => 'proj_poker_begin', '_controller' => 'App\\Controller\\Poker\\Begin\\PokerGameBeginController::projPokerBegin'], null, ['POST' => 0], null, false, false, null]],
        '/proj/poker' => [[['_route' => 'proj_poker', '_controller' => 'App\\Controller\\Poker\\PokerGameController::projPoker'], null, null, null, false, false, null]],
        '/proj' => [[['_route' => 'proj', '_controller' => 'App\\Controller\\Poker\\PokerHomeController::proj'], null, null, null, false, false, null]],
        '/proj/about' => [[['_route' => 'proj_about', '_controller' => 'App\\Controller\\Poker\\PokerHomeController::projAbout'], null, null, null, false, false, null]],
        '/proj/session' => [[['_route' => 'proj_session', '_controller' => 'App\\Controller\\Poker\\PokerHomeController::projSession'], null, null, null, false, false, null]],
        '/proj/reset' => [[['_route' => 'proj_reset', '_controller' => 'App\\Controller\\Poker\\PokerHomeController::projReset'], null, null, null, false, false, null]],
        '/proj/reset/post' => [[['_route' => 'proj_reset_post', '_controller' => 'App\\Controller\\Poker\\PokerResetController::projResetPost'], null, ['POST' => 0], null, false, false, null]],
        '/proj/poker/preflop' => [[['_route' => 'proj_poker_preflop', '_controller' => 'App\\Controller\\Poker\\Preflop\\PokerGamePreflopController::projPokerPreflop'], null, ['POST' => 0], null, false, false, null]],
