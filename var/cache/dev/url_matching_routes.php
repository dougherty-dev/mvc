...
return [
    ...
    [ // $dynamicRoutes
        ...
        289 => [[['_route' => 'api_library_book_isbn', '_controller' => 'App\\Controller\\LibraryController::apiLibraryBookIsbn'], ['isbn'], null, null, false, true, null]],
        322 => [[['_route' => 'card_deck_draw_number', '_controller' => 'App\\Controller\\CardProcessController::cardDeckDrawNumber'], ['number'], null, null, false, true, null]],
        355 => [[['_route' => 'card_deck_draw_deal_players', 'players' => 0, 'cards' => 0, '_controller' => 'App\\Controller\\CardProcessController::cardDeckDealPlayersCards'], ['players', 'cards'], null, null, false, true, null]],
        389 => [[['_route' => 'library_view_id', '_controller' => 'App\\Controller\\LibraryController::libraryViewID'], ['id'], null, null, false, true, null]],
        410 => [[['_route' => 'library_edit_id', '_controller' => 'App\\Controller\\LibraryController::libraryEditID'], ['id'], null, null, false, true, null]],
        433 => [
